<script>
  ...
  <div>
    <Card class="mb-3">
      <CardHeader>
        <CardTitle><h2>Integrado con las estadísticas sobre consumo de alcohol</h2></CardTitle>
      </CardHeader>
      <CardBody>
        <CardSubtitle />
        <CardText />
  ...
  <div>
    <Card class="mb-3">
      ...
      <CardBody>
        ...
        <a href="/#/integrations/cocktail"><Button color="primary">Estadísticas Bebidas Alcoholicas (Ext) </Button></a>
      </CardBody>
    </Card>
  </div>
